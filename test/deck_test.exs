defmodule DeckTest do
  ...
  test "suits returns available suits" do
    assert Deck.suits == [:d, :c, :h, :s]
  end

  test "values returns available values" do
    assert Deck.values == Enum.to_list(2..14)
  end

  test "deck of cards contains 52 elements" do
    assert length(Deck.generate) == 52
  end
  ...
  test "deck of cards contains all of the diamonds cards" do
    ...
    assert(Enum.all?(diamonds, fn(diamond) -> Enum.member?(Deck.generate, diamond) end))
  end
  ...
  test "deck of cards contains all of the clubs cards" do
    ...
    assert(Enum.all?(clubs, fn(club) -> Enum.member?(Deck.generate, club) end))
  end
  ...
  test "deck of cards contains all of the hearts cards" do
    ...
    assert(Enum.all?(hearts, fn(heart) -> Enum.member?(Deck.generate, heart) end))
  end
  ...
  test "deck of cards contains all of the spades cards" do
    ...
    assert(Enum.all?(spades, fn(spade) -> Enum.member?(Deck.generate, spade) end))
  end
end
